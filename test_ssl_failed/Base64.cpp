...
using namespace std;
// std::string base64_encode(unsigned char const* , unsigned int len);
string base64_encode(const unsigned char* Data,unsigned int DataByte)
{
    // https://blog.csdn.net/fengmm521/article/details/78438668
    //编码表
...
// std::string base64_decode(std::string const& s);
string base64_decode(std::string const& s/*,int DataByte=0,int& OutByte=0*/)
{
    const char* Data(s.c_str());
    int DataByte(s.length());
    //解码表
